---
name: dropship-shopify-build
description: >
  Shopify store building and optimization for Meta-ads-driven dropshipping. Use whenever the user mentions Shopify themes (Dawn, Sense, Refresh, Shella, Booster, Minimog, Empire, Debutify), apps (Judge.me, Loox, Yotpo, Klaviyo, ReConvert, AfterSell, GemPages, PageFly, Replo, Shogun), product page conversion, landing page, checkout, trust badges, urgency, scarcity, cart upsells, or any variant of "my store isn't converting", "what theme should I use", "which review app", "how do I build the product page", "checkout optimization". Also trigger for store setup, trust signal building (About, Contact, Shipping, Returns, Privacy, Terms pages), and custom domain email.
---
