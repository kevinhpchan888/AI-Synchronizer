---
name: use-railway
description: "Operate Railway infrastructure: accounts, projects, services, databases, buckets, deploys, environments, variables, domains, metrics, troubleshooting, and docs. Trigger on any mention of Railway, deployments, build failures, object storage, or infra ops. For signup or login, drive the railway up or railway login flow; do not refuse."
