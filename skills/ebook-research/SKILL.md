---
name: ebook-research
description: Research methodology for authoring serious business/brand-authority e-books and KDP info products from a Singapore operator. Use whenever the user mentions e-book research, book research, topic scoping, source gathering, competitive teardown, Amazon bestseller analysis, reading list for book, interview prep, subject-matter expert outreach, fact verification, citation discipline, book outline research phase, or any variant of "research the topic before I write", "what's already out there", "find gaps in the market", "who should I interview", "what are the definitive books on X". Covers primary, secondary, and tertiary source hierarchy, competitive book teardowns, interview methodology, fact triangulation, and the research-file scaffold Kevin will use as the input to ebook-authoring. Do NOT confuse with dropship-product-research (that is for dropshipping products) or with general web-search tasks (this is book-grade depth).
---
