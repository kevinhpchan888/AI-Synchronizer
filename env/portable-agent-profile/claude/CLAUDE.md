...
| `mcp__Claude_Preview__` | **Claude Preview** | Web app preview: start/stop, screenshots, click, console logs, network |
...
### Services
- ClaudeMaxProxy (:3456): Claude Max subscription proxy (localhost). Restart: `nssm restart ClaudeMaxProxy`
- Hermes Gateway (:18789): AMVCreator agent, @AMVCreator_Bot. Runs via Scheduled Task.
- Model chain: claude-max/sonnet-4 > claude-max/haiku-4 > gemini-flash > gemini-pro > openrouter/sonnet > featherless/kimi
