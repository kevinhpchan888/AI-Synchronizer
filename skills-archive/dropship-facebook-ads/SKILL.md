---
name: dropship-facebook-ads
description: >
  Meta/Facebook ads execution for dropshipping. Use whenever the user mentions Facebook ads, Meta ads, Advantage+, ASC, ABO, CBO, ad sets, campaigns, budget scaling, creative testing, kill criteria, lookalike audiences, interest targeting, broad targeting, pixel setup, Conversions API, CAPI, attribution, Triple Whale, Northbeam, iOS 17, ad policy, ad account bans, restricted categories, or any variant of "my ads aren't working", "should I scale this", "what's my break-even ROAS", "when do I kill an ad set". Also trigger for questions about business manager setup, ad account warmup, and the ban-resistance/antidetect ecosystem (flag as a crutch, teach compliant alternative).
---
