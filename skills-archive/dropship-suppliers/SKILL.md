---
name: dropship-suppliers
description: >
  Supplier arc from AliExpress entry to 1688 direct to private-label transition for a Meta-ads-only Shopify dropshipper based in Singapore. Use whenever the user mentions supplier, AliExpress, CJ Dropshipping, Zendrop, HyperSKU, Spocket, AutoDS, DSers, Alibaba, 1688, Taobao, sourcing agent, Superbuy, CSSBUY, Sugargoo, WeGoBuy, quality inspection, QIMA, SGS, Bureau Veritas, AQL, 3PL, ShipBob, ShipMonk, ShipHero, Packlane, Arka, Noissue, private label, Trade Assurance, CNY/Chinese New Year, Golden Week, supplier vetting, MOQ, FOB, DDP, or any variant of "where should I source this", "when do I move off AliExpress", "should I use an agent", "what's MOQ", "how do I handle CNY", "supplier won't respond". For supplier negotiation, redundancy, cultural norms (WeChat, guanxi), and red flags. Does NOT cover legal compliance (see legal-compliance) or banking for supplier payments (see cashflow-ops).
---
